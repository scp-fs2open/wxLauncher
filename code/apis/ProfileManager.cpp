...
/** EVT_PROFILE_EVENT */
LAUNCHER_DEFINE_EVENT_TYPE(EVT_PROFILE_CHANGE);
LAUNCHER_DEFINE_EVENT_TYPE(EVT_CURRENT_PROFILE_CHANGED);
...
bool ProMan::ProfileExists(const wxString& strName) const {
